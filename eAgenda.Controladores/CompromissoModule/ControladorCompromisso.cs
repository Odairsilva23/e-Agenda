...
namespace eAgenda.Controladores.CompromissoModule
{
    public class ControladorCompromisso : Controlador<Compromisso>
    {
        ...
        public override string InserirNovo(Compromisso registro)
        {
            ...
            {
                bool HorarioOcupado = SelecionarHorarioOcupado(registro.Data, registro.HoraInicio, registro.HoraTermino);
                if (HorarioOcupado)
                    resultadoValidacao = "Nesta Data e Horario Voce Ja tem Compromisso Agendado";
                else
        ...
        private bool SelecionarHorarioOcupado(DateTime data, TimeSpan horaInicio, TimeSpan horaTermino)
        {
